...
call addHocVien('0901014368', 'Le Hong Van', 0, 'Highschool Student', 'SH002');
...
call addHocVien('0926473829', 'Ngo Thi Bich', 0, 'Primary School Student', 'SH122');
call addHocVien('0973857294', 'Vo Duc Minh', 1, 'Highschool Student', 'SH122');
call addHocVien('0912457382', 'Truong Thi Huyen', 0, 'College Student', 'SH122');
call addHocVien('0945738291', 'Le Ngoc Phat', 1, 'University Student', 'SH122');
call addHocVien('0928463725', 'Nguyen Thi Hoa', 0, 'Secondary School Student', 'SH122');
call addHocVien('0935728491', 'Bui Duc Khang', 1, 'Highschool Student', 'SH122');
call addHocVien('0957382914', 'Tran Thi Huong', 0, 'Primary School Student', 'SH122');
